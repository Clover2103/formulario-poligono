...
<body>
    ...
    <header class="main-header">
        <div class="container mt-4">
            <div class="row">
                <div class="col-md-3">
                    <button id="crear_poli" class="btn btn-success">Crear nuevo poligono</button>
                </div>
                <div class="col-md-3">
                    <button id="consulta_poli" class="btn btn-primary">Consulta de poligono</button>
                </div>
                <div class="col-md-3">
                    <button id="crear_doce" class="btn btn-warning">Creacion de docentes</button>
                </div>
            </div>
        </div>
    </header>
